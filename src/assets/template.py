"""
Template prompt for financial numerical reasoning tasks.
This template guides the model to analyze financial data, generate reasoning steps, 
and produce executable programs to answer questions.
"""
